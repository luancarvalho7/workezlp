...
export function BusinessModelSelection({ onNext, onBack }: BusinessModelSelectionProps) {
  ...
  const businessModelOptions = ['B2B', 'B2C', 'B2B2C', 'SaaS', 'E-commerce', 'Marketplace', 'Subscription', 'Other'];
